...
public class RestBlogController {
    ...
    public ResponseEntity<List<Blog>> getCategory(@PathVariable String name) {
        //Category category = this.categoryService.findByName(name);
        List<Blog> blogList = this.blogService.findAllByName(name);
...
//        }
    ...
    public ResponseEntity<List<Blog>> getListBlogAjax() {
        List<Blog> blogList = this.blogService.findAllBlogAndSort() ;
        return new ResponseEntity<>(blogList, HttpStatus.OK);
    }
