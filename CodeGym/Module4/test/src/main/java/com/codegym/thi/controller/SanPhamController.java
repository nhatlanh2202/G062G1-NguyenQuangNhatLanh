...
public class SanPhamController {
    ...
    public ModelAndView listSanPham(@PageableDefault(value = 5) Pageable pageable,
        ...
        } else if (searchLoaiSanPham.equals("all") && searchGiaSanPham.equals("")){
            sanPhams = sanPhamService.findAllByTensanphamContaining(searchTenSanPham, pageable);
    ...
    public String createSanPham(@Validated @ModelAttribute("sanpham") SanPham sanPham, BindingResult bindingResult,
