...
public class SanPhamServiceImpl implements SanPhamService {
    ...
    @Override
    public Page<SanPham> findAllByTensanphamContaining(String name, Pageable pageable) {
        return this.sanPhamRepository.findAllByTensanphamContaining(name, pageable);
    }
