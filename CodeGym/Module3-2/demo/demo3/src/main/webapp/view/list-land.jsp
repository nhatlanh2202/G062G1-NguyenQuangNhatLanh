...
<%--                            Create Modal--%>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="search-box">
                            <i class="material-icons">&#xE8B6;</i>
                            <input type="text" name="landType" class="form-control" id="keywordTypeLandDisplay"
...
<form method="post" action="/land" id="formSearchLand">
    ...
    <input type="hidden" name="typeLand" id="keywordTypeLandHidden"/>
...
<script>
    ...
    function submitFormSearchLand() {
        ...
        let keywordTypeLandHidden = document.getElementById("keywordTypeLandHidden");
        let keywordTypeLandDisplay = document.getElementById("keywordTypeLandDisplay");
        keywordTypeLandHidden.value = keywordTypeLandDisplay.value;
