        ...
        <div class="table-wrapper" style="background-color:#f7f5f2 ">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <a href="/Exam?action=showCreate"><button>Thêm mới mặt bằng</button></a>
                    </div>
<%--                    <div class="col-sm-3">--%>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="edit" title="Edit"  data-toggle="modal"
                               data-target="#edit${matBang.ma_mat_bang}"><i class="far fa-edit"></i></a>
                            <div class="modal fade" id="#edit${matBang.ma_mat_bang}" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="/Exam?action=update" method="post"></form>
                                    </div>
                                </div>
                            </div>
                        </td>
