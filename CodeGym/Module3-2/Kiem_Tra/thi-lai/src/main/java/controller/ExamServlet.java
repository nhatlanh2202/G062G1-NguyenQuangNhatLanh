...
//        MatBang matBang = information(request);
//        String message = this.examBo.update(MatBang);
...
//        MatBang matBang = this.examBo.findByID(ma_mat_bang);
...
//        request.setAttribute("dtoMatBangList", dtoMatBangList);
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/exam/create.jsp");
...
//        request.setAttribute("message1", "OK !!!");
        String message = this.examBo.insertMatBang(matBang);
        request.setAttribute("message", message);

        request.setAttribute("matBang", matBang);

        showCreateMatBang(request, response);
//        RequestDispatcher dispatcher = request.getRequestDispatcher("/exam/create.jsp");
//        dispatcher.forward(request, response);
    }
